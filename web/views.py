...
def index(request):
	...
	if query:
		movies = Movie.objects.filter(Q(title__icontains=query) | Q(genre__icontains=query) | Q(director__icontains=query)).distinct()
...
def profile_update(request):
    ...
    return render(request, 'web/profile_update.html', context)
